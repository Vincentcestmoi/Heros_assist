...
public class Race {
    ...
    static Race zombie = new Race("zombie", 1, 6, 0, 1, 1, 2, zomb_comp);
    static Competence[] lich_comp = {Competence.ARMURE_GLACE, Competence.GEL};
    static Race liche = new Race("liche", 3, 8, 0, 1, 1, 3, lich_comp);
    ...
    static Race serpent = new Race("serpent", 2, 6, 0, 1, 1, 1, serp_comp);
    ...
    static Race serpent_geant = new Race("serpent geant", 4, 10, 0, 1, 1, 2, serpg_comp);
    ...
    static Race pegase_noir = new Race("pegase noir", 6, 20, 2, 1, 2, 2, pegan_comp);
    ...
    static Race pegase = new Race("pegase", 6, 23, 1, 1, 2, 2, pega_comp);
    ...
    static Race aurai_malefique = new Race("aurai Malefique", 10, 29, 1, 3, 3, 1, aura_comp);
    ...
    static Race illusion_aurai = new Race("aurai Malefique", 10, 29, 1, 2, 3, 1, illu_comp);
