...
public class Pre_Equipement {
    ...
    static Pre_Equipement bracelet0 = new Pre_Equipement("bracelet de protection cabossé", BRACELET, O,
            Effet_equip.RESISTANCE1, true);
    ...
    static Pre_Equipement main1_a = new Pre_Equipement("dague enchantée", MAIN1, I, Effet_equip.ATTAQUE1, true);
    static Pre_Equipement main1_a_bis = new Pre_Equipement("dague enchantée ", MAIN1, I, Effet_equip.ATTAQUE1, true);
    ...
    static Pre_Equipement casque_r = new Pre_Equipement("casque de bonne facture", CASQUE, I, Effet_equip.RESISTANCE1
            , true);
    ...
    static Pre_Equipement main1_ba_bis = new Pre_Equipement("coutelat ", MAIN1, I, Effet_equip.BAD_ALLONGE, true);
    ...
    static Pre_Equipement elem_casque = new Pre_Equipement("Diadème de flamme", CASQUE, I, Effet_equip.COIFFE_FEU,
            true);
    static Pre_Equipement elem_armure = new Pre_Equipement("Armure de glace", ARMURE, I, Effet_equip.ARMURE_GLACE,
            true);
    static Pre_Equipement elem_bouclier = new Pre_Equipement("Bouclier des roches", BOUCLIER, I,
            Effet_equip.BOUCLIER_TERRE, true);
    static Pre_Equipement bracelet_r1 = new Pre_Equipement("Bracelet de protection", BRACELET, I,
            Effet_equip.RESISTANCE2, true);
    static Pre_Equipement bracelet_r1_bis = new Pre_Equipement("Bracelet de protection ", BRACELET, I,
            Effet_equip.RESISTANCE2, true);
    static Pre_Equipement bracelet_ar1 = new Pre_Equipement("Bracelet du défenseur", BRACELET, I, Effet_equip.ARMURE1
            , true);
    static Pre_Equipement bracelet_a1 = new Pre_Equipement("Bracelet de force", BRACELET, I, Effet_equip.ATTAQUE1,
            true);
    static Pre_Equipement bracelet_a1_bis = new Pre_Equipement("Bracelet de force ", BRACELET, I,
            Effet_equip.ATTAQUE1, true);
    ...
    static Pre_Equipement rune_feu_bis = new Pre_Equipement("Rune ardente ", AUTRE, I, Effet_equip.RUNE_ARDENTE, true);
    ...
    static Pre_Equipement[] rang1 = {fleche_plusI, fleche_plusI2, fleche_plusI3, fleche_plusI4, fleche_plusI5,
            ...
            bouclier_w, armure_a, casque_a, bouclier_a, main1_a, main1_a_bis, main2_a, armure_r, casque_r, bouclier_r
            , main2_r, main1_ba, main1_ba_bis, main2_ba, armure_ar, elem_main, elem_casque, elem_armure,
            elem_bouclier, bracelet_r1, bracelet_r1_bis, bracelet_ar1, bracelet_a1, bracelet_a1_bis, bracelet_ra1,
            epee_fertile, parchemin_feu, parch_force, rune_croiss, rune_feu, rune_feu_bis, rune_pluie, rune_haine,
            rune_virale, rune_orage, rune_mort, rune_dodo, rune_commerce, popoI};
    ...
    static Pre_Equipement fleche_plusII3 = new Pre_Equipement("projectile incendiare", AUTRE, II, Effet_equip.ARCA,
            true);
    ...
    static Pre_Equipement bouclierII_ar = new Pre_Equipement("bouclier renforcé", BOUCLIER, II, Effet_equip.ARMURE1,
            true);
    static Pre_Equipement armureII_r = new Pre_Equipement("armure de bonne facture", ARMURE, II,
            Effet_equip.RESISTANCE2, true);
    static Pre_Equipement casque_II_r = new Pre_Equipement("casque de qualité", CASQUE, II, Effet_equip.RESISTANCE2,
            true);
    static Pre_Equipement bouclierII_r = new Pre_Equipement("bon bouclier", BOUCLIER, II, Effet_equip.RESISTANCE2,
            true);
    static Pre_Equipement main1II_ba = new Pre_Equipement("dague", MAIN1, II, Effet_equip.BAD_ALLONGE, true);
    static Pre_Equipement main1II_ba_bis = new Pre_Equipement("dague ", MAIN1, II, Effet_equip.BAD_ALLONGE, true);
    ...
    static Pre_Equipement bracelet_energie = new Pre_Equipement("Bracelet d'absorption", BRACELET, II,
            Effet_equip.BRACELET_ABSO, true);
    static Pre_Equipement bracelet_energie_bis = new Pre_Equipement("Bracelet d'absorption ", BRACELET, II,
            Effet_equip.BRACELET_ABSO, true);
    ...
    static Pre_Equipement bracelet_a2 = new Pre_Equipement("Bracelet de puissance", BRACELET, II,
            Effet_equip.ATTAQUE2, true);
    static Pre_Equipement bracelet_r2 = new Pre_Equipement("Bracelet défensif", BRACELET, II, Effet_equip.RESISTANCE4
            , true);
    static Pre_Equipement fleche_plusIIex = new Pre_Equipement("flèche explosive", AUTRE, II, Effet_equip.ARCEXP, true);
    static Pre_Equipement fleche_plusIIex_bis = new Pre_Equipement("flèche explosive ", AUTRE, II, Effet_equip.ARCEXP
            , true);
    static Pre_Equipement parchemin_dodo = new Pre_Equipement("Parchemin de sommeil", AUTRE, II,
            Effet_equip.PARCH_DODO, true);
    static Pre_Equipement rune_feu2 = new Pre_Equipement("Rune incinérante", AUTRE, II, Effet_equip.RUNE_ARDENTE2,
            true);
    static Pre_Equipement rune_feu2_bis = new Pre_Equipement("Rune incinérante ", AUTRE, II,
            Effet_equip.RUNE_ARDENTE2, true);
    static Pre_Equipement medail_protect = new Pre_Equipement("Médaillon de protection", AUTRE, II,
            Effet_equip.PROTECTION, true);
    ...
    static Pre_Equipement bracelet_maudit = new Pre_Equipement("Bracelet maudit", BRACELET, II,
            Effet_equip.BRACELET_MAUDIT, true);
    ...
    static Pre_Equipement[] rang2 = {fleche_plusII, fleche_plusII2, fleche_plusII3, fleche_plusII4, ceintureII, arcII
            ...
            armureII_r, casque_II_r, bouclierII_r, main1II_ba, main1II_ba_bis, main2II_ba, main2II_ga, lame_mer,
            bracelet_energie, bracelet_energie_bis, bracelet_soin, bracelet_ra2, bracelet_a2, bracelet_r2,
            fleche_plusIIex, fleche_plusIIex_bis, parchemin_dodo, rune_feu2, rune_feu2_bis, popoII, healII,
            medail_protect, lunette, rune_veng, rune_necro, bracelet_maudit, dissect, alchi, bourdon};
    ...
    static Pre_Equipement healPPIII = new Pre_Equipement("drogue de guerre", CONSO_EX, III, Effet_equip.CONSO_EXT3,
            false);
    
    static Pre_Equipement fleche_plusIII = new Pre_Equipement("pointe torsadée", AUTRE, III, Effet_equip.ARCA, true);
    static Pre_Equipement fleche_plusIII2 = new Pre_Equipement("structure enchantée", AUTRE, III, Effet_equip.ARCA,
            true);
    static Pre_Equipement fleche_plusIII3 = new Pre_Equipement("pointe électrique", AUTRE, III, Effet_equip.ARCA, true);
    static Pre_Equipement bracelet_ar3 = new Pre_Equipement("Bracelet d'invincibilité", BRACELET, III,
            Effet_equip.ARMURE2, true);
    static Pre_Equipement bracelet_r3 = new Pre_Equipement("Bracelet de l'immortel", BRACELET, III,
    ...
    static Pre_Equipement bouclierIII_ar = new Pre_Equipement("bouclier renforcé", BOUCLIER, III, Effet_equip.ARMURE1
            , true);
    static Pre_Equipement armureIII_ar = new Pre_Equipement("chef d'oeuvre", ARMURE, III, Effet_equip.ARMURE2, true);
    static Pre_Equipement armureIII_r = new Pre_Equipement("très bonne armure", ARMURE, III, Effet_equip.RESISTANCE2,
            true);
    static Pre_Equipement casque_III_r = new Pre_Equipement("casque supérieur", CASQUE, III, Effet_equip.RESISTANCE2,
            true);
    static Pre_Equipement bouclierIII_r = new Pre_Equipement("excellent bouclier", BOUCLIER, III,
            Effet_equip.RESISTANCE2, true);
    static Pre_Equipement main1III_ba = new Pre_Equipement("dague courte", MAIN1, III, Effet_equip.BAD_ALLONGE, true);
    static Pre_Equipement main1III_ba_bis = new Pre_Equipement("dague courte ", MAIN1, III, Effet_equip.BAD_ALLONGE,
            true);
    static Pre_Equipement main2III_ba = new Pre_Equipement("arbuste", MAIN2, III, Effet_equip.BAD_ALLONGE, true);
    static Pre_Equipement main2III_ga = new Pre_Equipement("lance celeste", MAIN2, III, Effet_equip.BONNE_ALLONGE,
            true);
    ...
    static Pre_Equipement bracelet_max = new Pre_Equipement("Bracelet suprême", BRACELET, III,
            Effet_equip.BRACELETMAX, true);
    ...
    static Pre_Equipement[] rang3 = {fleche_plusIII, fleche_plusIII2, fleche_plusIII3, ceintureIII, arcIII, dagueIII,
            ...
            main1III_ba, main1III_ba_bis, main2III_ba, main2III_ga, lame_mont, armureIII_ar, main1III_a, bracelet_max};
    ...
    static Pre_Equipement braceletIV = new Pre_Equipement("Bracelet divin", BRACELET, IV, Effet_equip.BRACELET_DIVIN,
            true);
    ...
    static Pre_Equipement tal_ar = new Pre_Equipement("Talisman d'acier", AUTRE, PROMOTION, Effet_equip.ARMURE1,
            Promo_Type.AMELIORATION);
    static Pre_Equipement tal_a = new Pre_Equipement("Talisman offensif", AUTRE, PROMOTION, Effet_equip.ATTAQUE2,
            Promo_Type.AMELIORATION);
    static Pre_Equipement tal_r = new Pre_Equipement("Talisman défensif", AUTRE, PROMOTION, Effet_equip.RESISTANCE3,
            Promo_Type.AMELIORATION);
    static Pre_Equipement fleche_plusP = new Pre_Equipement("Tir assisté", AUTRE, PROMOTION, Effet_equip.ARCA,
            Promo_Type.AMELIORATION);
    static Pre_Equipement fleche_plusP2 = new Pre_Equipement("Bénédiction magique", AUTRE, PROMOTION,
            Effet_equip.ARCA, Promo_Type.AMELIORATION);
    static Pre_Equipement fleche_plusP3 = new Pre_Equipement("Flèches chamaniques", AUTRE, PROMOTION,
            Effet_equip.ARCA, Promo_Type.AMELIORATION);
    ...
    static Pre_Equipement fuite = new Pre_Equipement("Téleporteur courte porté", AUTRE, PROMOTION, Effet_equip.FUITE,
            Promo_Type.ARTEFACT);
    static Pre_Equipement parch_lum = new Pre_Equipement("Parchemin de lumière", AUTRE, PROMOTION,
            Effet_equip.PARCH_LUMIERE, Promo_Type.ARTEFACT);
    static Pre_Equipement grenade = new Pre_Equipement("Grenades", CONSO_EX, PROMOTION, Effet_equip.GRENADE,
            Promo_Type.ARTEFACT);
    static Pre_Equipement popo_vitesse = new Pre_Equipement("Amulette mystérieuse", AUTRE, PROMOTION,
    ...
    static Pre_Equipement barque = new Pre_Equipement("Navire magique", AUTRE, PROMOTION, Effet_equip.MER_EXP,
            Promo_Type.ARTEFACT);
    static Pre_Equipement barriere = new Pre_Equipement("Protection absolue", AUTRE, PROMOTION,
            Effet_equip.ITEM_IMMUN, Promo_Type.ARTEFACT);
    static Pre_Equipement seconde_chance = new Pre_Equipement("Sacoche temporelle", AUTRE, PROMOTION,
            Effet_equip.SAC_TEMP, Promo_Type.ARTEFACT);
    
    static Pre_Equipement[] prom_list_arte = {rune_anni, rez, fuite, parch_lum, grenade, popo_vitesse, popo_PP,
