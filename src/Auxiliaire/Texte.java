...
public class Texte {
    ...
    public static void thaumaturge(int PIT, int Po) {
        System.out.printf("Grâce à vos dons, vous pouvez choisir %d pièces d'équipements que vous conservez (vous " + "devez entrer à nouveau les effets cachées). De plus, vous pouvez conserver jusqu'à %d PO.", PIT, Po);
    }
